...
fn hardlight_and_overlay(color1: (f32, f32, f32, f32), color2: (f32, f32, f32)) -> (f32, f32, f32, f32) {
...
pub(crate) fn compute_blend(
    blending_mode: &BlendingMode, color1: (f32, f32, f32, f32), color2: (f32, f32, f32)
) -> (f32, f32, f32, f32) {
    match blending_mode {
        BlendingMode::Darken => {
            (color1.0.min(color2.0), color1.1.min(color2.1), color1.2.min(color2.2), color1.3)
        }
        BlendingMode::Multiply => {
            (color1.0 * color2.0, color1.1 * color2.1, color1.2 * color2.2, color1.3)
        }
        ...
        BlendingMode::Lighten => {
            (color1.0.max(color2.0), color1.1.max(color2.1), color1.2.max(color2.2), color1.3)
        }
        BlendingMode::Screen => {
            (
